...
const corePlugin: PluginManifest = {
  ...
  routes: [
    ...
    { key: "route-pos", path: "/pos", permission: "pos.manage", requiresTenant: true, requiresBranch: true },
    { key: "route-hardware", path: "/hardware-integration", permission: "pos.manage", requiresTenant: true, requiresBranch: true },
